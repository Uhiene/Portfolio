...
const AboutSection = () => {
  return (
    ...
    >
      ...
      {/* About Text */}
      <div className="lg:w-1/2 md:w-full mt-8 lg:mt-0 lg:absolute inset-x-[47%] top-1/4">
        <div className="">
          ...
          <p className="text-lg lg:text-2xl font-light lg:font-extralight text-white mt-8 lg:mt-10 font-sans leading-loose lg:leading-relaxed">
          ...
          <Button text="Download CV" width="50%" />
          </div>
        </div>
      </div>
    </div>
